...
class TestJournalReport(TransactionCase):
    def setUp(self):
        ...
        self.JournalLedgerReport = self.env["report.account_financial_report.journal_ledger"]
    ...
    def check_report_journal_debit_credit(self, res_data, expected_debit, expected_credit):
        self.assertEqual(expected_debit, sum(rec["debit"] for rec in res_data["Journal_Ledgers"]))
