    ...
    def _get_report_filters(self, report):
        return [
            ...
            [
                ...
                _("All posted entries") if report.target_move == "posted" else _("All entries"),
            ],
            [
    ...
    def _generate_report_content(self, workbook, report, data, report_data):
        ...
        for account in general_ledger:
            ...
            if not account["partners"]:
                ...
                if foreign_currency:
                    account.update({"initial_bal_curr": account["init_bal"]["bal_curr"]})
                ...
                for partner in account["list_partner"]:
                    # Write partner title
                    self.write_array_title(partners_data[partner["id"]]["name"], report_data)
