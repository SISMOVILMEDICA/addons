...
class GeneralLedgerReportWizard(models.TransientModel):
    ...
    account_journal_ids = fields.Many2many(comodel_name="account.journal", string="Filter journals")
    ...
    def onchange_company_id(self):
        ...
        if not self.company_id:
            ...
            res["domain"]["account_journal_ids"] += [("company_id", "=", self.company_id.id)]
            res["domain"]["partner_ids"] += self._get_partner_ids_domain()
            res["domain"]["cost_center_ids"] += [("company_id", "=", self.company_id.id)]
