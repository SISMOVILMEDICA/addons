...
class JournalLedgerReportWizard(models.TransientModel):
    ...
    move_target = fields.Selection(selection="_get_move_targets", default="posted", required=True)
    ...
    @api.model
    def _get_ml_tax_description(self, move_line_data, tax_line_data, move_line_taxes_data):
        taxes_description = ""
