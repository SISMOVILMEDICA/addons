...
class OnboardingController(http.Controller):
    @http.route(
        "/website_sale_dashboard/website_sale_dashboard_onboarding", auth="user", type="json"
    )
    def website_dashboard_onboarding(self):
        ...
        if (
            ...
            or company.website_sale_dashboard_onboarding_state == "closed"
        ):
            return {}

        return {
            "html": request.env.ref(
                "website_sale_dashboard.website_sale_dashboard_onboarding_panel"
            )._render(
                {
                    "company": company,
