...
class AccountMoveLine(models.Model):
    ...
    predict_from_name = fields.Boolean(
        store=False, help="Technical field used to know on which lines the prediction must be done."
    )
    ...
    def _predict_field(self, sql_query, description):
        ...
        limit_parameter = (
            ...
            .sudo()
            .get_param("account.bill.predict.history.limit", "10000")
        )
        params = {
            "lang": psql_lang,
